...
declare namespace PhaserSpine.canvas {
...
declare namespace PhaserSpine.webGL {
    enum TextureFilter {
        Nearest = 9728,
        Linear = 9729,
        MipMap = 9987,
    ...
    class Texture extends PIXI.BaseTexture {
        protected image: HTMLImageElement;
        constructor(image: HTMLImageElement, scaleMode?: number);
        getImage(): HTMLImageElement;
        dispose(): void;
        setFilters(minFilter: spine.TextureFilter, magFilter: spine.TextureFilter): void;
        setWraps(uWrap: spine.TextureWrap, vWrap: spine.TextureWrap): void;
...
declare namespace PhaserSpine {
    class SpinePlugin extends Phaser.Plugin {
        static readonly RESOLUTION_REGEXP: RegExp;
        static readonly SPINE_NAMESPACE: string;
        static readonly ATLAS_PREFIX: string;
        static DEBUG: boolean;
        static TRIANGLE: boolean;
        constructor(game: SpineGame, parent: Phaser.PluginManager);
        init(config?: Config): void;
        protected addSpineCache(): void;
        protected addSpineFactory(): void;
        protected addSpineLoader(): void;
    }
}
