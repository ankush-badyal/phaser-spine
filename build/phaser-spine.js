...
(function (PhaserSpine) {
    ...
    (function (webGL) {
        ...
        (function (TextureFilter) {
            ...
            TextureFilter[TextureFilter["MipMapNearestLinear"] = 9986] = "MipMapNearestLinear";
            TextureFilter[TextureFilter["MipMapLinearLinear"] = 9987] = "MipMapLinearLinear";
        })(TextureFilter = webGL.TextureFilter || (webGL.TextureFilter = {}));
        var TextureWrap;
        (function (TextureWrap) {
            TextureWrap[TextureWrap["MirroredRepeat"] = 33648] = "MirroredRepeat";
            TextureWrap[TextureWrap["ClampToEdge"] = 33071] = "ClampToEdge";
            TextureWrap[TextureWrap["Repeat"] = 10497] = "Repeat";
        })(TextureWrap = webGL.TextureWrap || (webGL.TextureWrap = {}));
        var Texture = (function (_super) {
            __extends(Texture, _super);
            function Texture(image, scaleMode) {
                if (scaleMode === void 0) { scaleMode = 1; }
                var _this = _super.call(this, image, scaleMode) || this;
                _this.image = image;
                return _this;
            }
            Texture.prototype.getImage = function () {
...
(function (PhaserSpine) {
    var Spine = (function (_super) {
        ...
        Spine.prototype.createSkeleton = function (key) {
            var _this = this;
            var rawAtlasData = this.game.cache.getText(PhaserSpine.SpinePlugin.ATLAS_PREFIX + "_" + key);
            var rawJSONData = this.game.cache.getJSON(PhaserSpine.SpinePlugin.SPINE_NAMESPACE + "_" + key);
            var spineAtlas = new spine.TextureAtlas(rawAtlasData, function (line) {
                console.log("spineAtlas line ", line);
                if (_this.game.renderType === Phaser.CANVAS) {
                    return new PhaserSpine.canvas.Texture(_this.game.cache.getImage(line));
                }
                return new PhaserSpine.webGL.Texture(_this.game.cache.getImage(line));
            });
            var atlasLoader = new spine.AtlasAttachmentLoader(spineAtlas);
            var spineJsonParser = new spine.SkeletonJson(atlasLoader);
            var skeletonData = spineJsonParser.readSkeletonData(rawJSONData);
            return new spine.Skeleton(skeletonData);
        };
        Spine.prototype.setSpineState = function () {
            this.stateData = new spine.AnimationStateData(this.skeleton.data);
            this.state = new spine.AnimationState(this.stateData);
        };
        Spine.prototype.bindEvents = function () {
...
(function (PhaserSpine) {
    ...
    var SpinePlugin = (function (_super) {
        ...
        SpinePlugin.prototype.addSpineLoader = function () {
            ...
            function spineLoad(key, url, urlAtlas, urlImages) {
                var _this = this;
                var imageKeys = [];
                var imagesLoaded = 0;
                this.text(SpinePlugin.ATLAS_PREFIX + "_" + key, urlAtlas);
                this.json(SpinePlugin.SPINE_NAMESPACE + "_" + key, url);
                if (Array.isArray(urlImages)) {
                    urlImages.forEach(function (fileName) {
                        var fileNameOnly = fileName.substring(fileName.lastIndexOf('/') + 1);
                        _this.image(fileNameOnly, fileName);
            ...
            Phaser.Loader.prototype.spine = function (key, url, urlAtlas, urlImages) {
        ...
        SpinePlugin.ATLAS_PREFIX = "atlas_" + SpinePlugin.SPINE_NAMESPACE + "_";
